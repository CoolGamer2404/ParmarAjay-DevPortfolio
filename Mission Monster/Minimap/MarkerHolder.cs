...
public class MarkerHolder : MonoBehaviour
{
    ...
    public GameObject bigmarkerPrefab;
    ...
    public void AddObjectiveBigMarker(ObjectivePosition sender) {
        RectTransform rectTransform = Instantiate(bigmarkerPrefab, markerParentRectTransform).GetComponent<RectTransform>();
        currentObjectives.Add((sender, rectTransform));
    }
