...
public class BossDrone1_Attack_ShootAsteroid : BossDrone1_BaseState
{
    public BossDrone1_Attack_ShootAsteroid(BossDrone1_StateMachine currentContextBossDroneAI, BossDrone1_StateFactory StateFactoryBossDroneAI) : base(currentContextBossDroneAI, StateFactoryBossDroneAI)
    {
    ...
    public override void EnterState()
    {
        ...
        _ctxBossDroneAI.AsteroidsAmount=Random.Range(5,12);
    ...
    private void GenerateRandomPoints()
    {
        ...
        int pointsCount = _ctxBossDroneAI.AsteroidsAmount;

        // Generate points far from player
        for (int i = 0; i < pointsCount; i++)
        {
            Vector3 point = GeneratePoints();
            _ctxBossDroneAI.InstantiateAsteroidTargetIndicator(point);
        }
    }
